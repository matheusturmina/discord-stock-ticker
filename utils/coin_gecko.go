...
func GetCryptoPriceCache(client *redis.Client, ctx context.Context, ticker string) (GeckoPriceResults, bool, error) {
	...
	if (err == redis.Nil) || (err != nil) {
		...
		return geckoPriceResults, false, err
	} else {
	...
	return geckoPriceResults, true, nil
}
